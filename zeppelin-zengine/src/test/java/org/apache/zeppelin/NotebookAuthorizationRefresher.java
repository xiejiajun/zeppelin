 ...
 */
public class NotebookAuthorizationRefresher {
  private static final Logger LOG = LoggerFactory.getLogger(NotebookAuthorizationRefresher.class);
  private static NotebookAuthorizationRefresher instance = null;
  /*
  ...
  private NotebookAuthorizationRefresher() {}

  public static NotebookAuthorizationRefresher init(ZeppelinConfiguration config) {
    if (instance == null) {
      instance = new NotebookAuthorizationRefresher();
      conf = config;
      try {
  ...
  public static NotebookAuthorizationRefresher getInstance() {
    if (instance == null) {
